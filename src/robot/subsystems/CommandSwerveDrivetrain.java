...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private final PIDController m_pathXController = new PIDController(1.3, 0.1, 0.3);
    private final PIDController m_pathYController = new PIDController(1.3, 0.1, 0.3);
    private final PIDController m_pathThetaController = new PIDController(1.3, 0, 0);
