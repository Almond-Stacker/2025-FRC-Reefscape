...
//                 PhotonConstants.aprilTagFieldLayout, //figure custom April Tag feld creation
...
//                         .filter(target -> target.getPoseAmbiguity() < PhotonConstants.MIN_AMBIGUITY)
//                         .toList();
...
//         } else if (currentTime - lastUpdateTime > PhotonConstants.TIMEOUT) {
//             collectiveEstimatedPose = Optional.of(PhotonConstants.NO_APRILTAG_ESTIMATE); //clear result if too great of time difference
